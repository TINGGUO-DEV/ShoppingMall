<%@ Page Language = "C#" AutoEventWireup = "true" CodeBehind = "BGOrder.aspx.cs" Inherits = "ShoppingMall.aspx.BGOrder" %>
...
<meta http-equiv = "Content-Type" content = "text/html; charset = utf-8"/>
    ...
    <script src = "../bgJS/BGOrder.js" type = "text/javascript"></script>
...
<body>
    <div id = "bgWeb">  
        ...
        <div id = "bgRightSpace">
                <div id = "bgRightSpaceTitle">訂單管理</div>
