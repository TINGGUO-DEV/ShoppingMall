<%@ Page Language = "C#" AutoEventWireup = "true" CodeBehind = "BGProd.aspx.cs" Inherits = "ShoppingMall.aspx.BGProd" %>
...
<meta http-equiv = "Content-Type" content = "text/html; charset = utf-8"/>
    ...
    <script src = "../bgJS/BGProd.js" type = "text/javascript"></script>
...
<body>
    ...
    <div id = "bgRightSpace">
            <div id = "bgRightSpaceTitle">商品管理</div>
