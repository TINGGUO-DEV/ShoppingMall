    ...
    <div id="mbrContainer">
        ...
        <div id="mbrRightSpace">
            <div class="txbAllInputBox">
                ...
                <p>
                    <span>姓名：</span>
                    <input type="text" placeholder="請輸入真實姓名" oninput="NameInput(this)" maxlength="10" title="以利商品寄送及中獎資訊告知" required />
                </p>
                <p>
                    <span>地址：</span>
                    <input type="text" placeholder="請輸入正確的通訊地址，以利商品寄送" maxlength="100" />
                </p>
                <p>
                    <span>信箱：</span>
                ...
                <div>
                    ...
                    <div class="popUpConfBox" id="popUpConfirm">
                        ...
                        <div class="btnsBox">
                            <button class="btnCancel" onclick="ClosePopUp('popUpConfirm')">取消</button>
